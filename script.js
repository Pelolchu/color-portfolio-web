class ComparisonSlider {
    ...
    init() {
        // Confiar en autoplay nativo y solo sincronizar muy ligeramente
        this.startLightSync();
    ...
    startLightSync() {
        // Sincronización ultra-ligera, solo para evitar desfasajes grandes
        setInterval(() => {
            // Solo sincronizar si hay desfasaje muy notorio (> 0.1 segundos)
        ...
        }, 500); // Check cada 500ms, no cada frame
    }
